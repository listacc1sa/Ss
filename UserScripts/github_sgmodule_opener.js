...
(function () {
  ...
  setTimeout(function () {
    ...
    function openScriptHubLink() {
        ...
        // 生成 ScriptHub 链接
        const scriptHubUrl = `http://script.hub/file/_start_/${rawUrl}/_end_/Tg_url_turrit.sgmodule?type=qx-rewrite&target=surge-module&del=true`;
